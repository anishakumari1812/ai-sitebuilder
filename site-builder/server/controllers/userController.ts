...
export const purchaseCredits = async (req: Request, res: Response) => {
  try {
    ...
    const plans = {
      basic: { credits: 100, amount: 500 },
      pro: { credits: 400, amount: 1900 },
      enterprise: { credits: 1000, amount: 4900 },
    };
    ...
    const paymentLink = await razorpay.paymentLink.create({
      amount: plan.amount,
      currency: "INR",
      description: `AiSiteBuilder - ${plan.credits} credits`,
      callback_url: `${origin}/loading?transactionId=${transaction.id}`,
      callback_method: "get",
      notes: {
